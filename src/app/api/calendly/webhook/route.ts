 ...
 * 3. Set URL to: https://www.moonlstudios.com/api/calendly/webhook
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="color: #6b7280; font-size: 12px;">
            ...
            <a href="https://www.moonlstudios.com" style="color: #0EA5E9;">moonlstudios.com</a>
          </p>
        </div>
      `,
    });
...
async function sendPostConsultationSurvey(name: string, email: string, eventUri: string) {
  ...
  const surveyUrl = `https://www.moonlstudios.com/testimonial?name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&event=${encodeURIComponent(eventUri)}`;
        ...
        <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin-top: 30px; text-align: center;">
            <p style="color: #94a3b8; font-size: 12px;">
              Moonlit Studios | Where healthcare expertise meets cutting-edge development<br>
              <a href="https://www.moonlstudios.com" style="color: #0ea5e9; text-decoration: none;">moonlstudios.com</a>
            </p>
          </div>
        </div>
      `,
