    ...
    <div className="min-h-screen bg-gradient-to-b from-nightNavy via-deepOcean to-midnight relative overflow-hidden">
      ...
      <section id="hero" className="relative overflow-hidden border-b border-green-500/20 bg-gradient-to-br from-midnight via-deepOcean/80 to-nightNavy py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center z-10">
          ...
          <div className="flex justify-center items-center gap-1.5 xs:gap-2 sm:gap-4 md:gap-6 flex-wrap mb-8">
            <div
              className="w-5 h-5 xs:w-6 xs:h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-midnight border-2 border-green-300/60 shadow-lg shadow-green-300/30 animate-pulse flex-shrink-0"
              title="New Moon - Seeds of Dreams"
              style={{ animationDuration: '3s' }}
            />
            <div className="hidden xs:block h-0.5 w-4 sm:w-8 md:w-12 bg-gradient-to-r from-green-300/40 to-orange-200/40" />

            <div
              className="w-5 h-5 xs:w-7 xs:h-7 sm:w-9 sm:h-9 md:w-11 md:h-11 rounded-full bg-gradient-to-br from-midnight via-orange-200/50 to-orange-200/80 border-2 border-orange-200/70 shadow-lg shadow-orange-200/40 animate-pulse flex-shrink-0"
              title="Crescent - Growth Begins"
              style={{ animationDuration: '3.5s' }}
            />
            <div className="hidden xs:block h-0.5 w-4 sm:w-8 md:w-12 bg-gradient-to-r from-orange-200/50 to-pink-300/60" />

            <div
              className="w-7 h-7 xs:w-8 xs:h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-green-300 via-pink-300 to-purple-200 border-2 border-pink-300/90 shadow-xl shadow-pink-300/60 animate-pulse flex-shrink-0"
              title="Full Moon - Your Journey"
              style={{ animationDuration: '2.5s' }}
            />
            <div className="hidden xs:block h-0.5 w-4 sm:w-8 md:w-12 bg-gradient-to-r from-pink-300/60 to-purple-200/50" />

            <div
              className="w-5 h-5 xs:w-7 xs:h-7 sm:w-9 sm:h-9 md:w-11 md:h-11 rounded-full bg-gradient-to-br from-purple-200/70 via-purple-200/50 to-midnight border-2 border-purple-200/70 shadow-lg shadow-purple-200/40 animate-pulse flex-shrink-0"
              title="Waning - Flourishing"
              style={{ animationDuration: '3.5s' }}
            />
            <div className="hidden xs:block h-0.5 w-4 sm:w-8 md:w-12 bg-gradient-to-r from-purple-200/40 to-sky-300/30" />

            <div
              className="w-5 h-5 xs:w-6 xs:h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-midnight border-2 border-sky-300/60 shadow-lg shadow-sky-300/30 animate-pulse flex-shrink-0"
