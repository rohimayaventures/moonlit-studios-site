...
// 🏮 STUDIO GHIBLI LANTERN - Floating magical light
...
// Forest leaves floating in the breeze
const FloatingLeaf = ({ delay = 0, className = "" }: { delay?: number; className?: string }) => (
  <div
    className={`absolute ${className} animate-floatLeaf`}
...
// Soft cloud shapes like in Ghibli films
...
const FAQItem = ({
  ...
  <details
    open={isOpen}
    className="group rounded-lg border border-white/10 bg-white/5 p-6 hover:border-green-300/30 transition-all"
  >
    <summary
    ...
    <p className="mt-4 text-moonlightSilver leading-relaxed">
      {answer}
    </p>
  </details>
);
...
export default function SmallBusinessPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-nightNavy via-deepOcean to-midnight relative overflow-hidden">
      {/* Floating leaves throughout the page */}
      <FloatingLeaf delay={0} className="top-20 left-10" />
      <FloatingLeaf delay={2} className="top-40 right-20" />
      <FloatingLeaf delay={4} className="top-60 left-1/3" />
      <FloatingLeaf delay={1} className="bottom-40 right-1/4" />
      <FloatingLeaf delay={3} className="bottom-60 left-1/4" />
      ...
      <section id="hero" className="relative overflow-hidden border-b border-green-500/20 bg-gradient-to-br from-midnight via-deepOcean/80 to-nightNavy py-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <GhibliCloud className="absolute bottom-20 left-0 w-full h-20 text-purple-200 opacity-20" />
          <div className="absolute top-32 right-1/4 h-32 w-32 rounded-full bg-green-300/10 blur-3xl" />
          <div className="absolute bottom-32 left-1/4 h-40 w-40 rounded-full bg-purple-200/10 blur-3xl" />
        </div>

        <div className="relative mx-auto max-w-4xl px-6 text-center">
          {/* Studio Ghibli Moon Phases - Pastel Forest Palette */}
          <div className="flex justify-center items-center gap-3 sm:gap-4 md:gap-8 mb-8">
            {/* Phase 1: Pastel Green */}
            <div
      ...
      <section className="py-16 px-6 border-b border-green-500/20 bg-midnight/30 relative">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-green-300/20 bg-gradient-to-br from-green-300/10 via-pink-200/5 to-transparent p-8 md:p-12 backdrop-blur-sm">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-moonlightSilver">
              ...
              <p className="text-pink-300 font-semibold italic">
                You deserve a website as beautiful as what you create.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          SECTION 3: TIERED PRICING (LOW → HIGH)
      ═══════════════════════════════════════════════════════════════════ */}
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {packages.map((pkg, index) => (
              <div
                ...
                } ${index === 1 ? 'ring-2 ring-purple-400/50' : ''}`}
              >
                {/* Most Popular Badge */}
                {index === 1 && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                    <span className="px-4 py-1 rounded-full bg-gradient-to-r from-purple-400 via-pink-300 to-green-300 text-xs font-bold text-midnight shadow-lg">
                      ⭐ MOST POPULAR
                    </span>
                  </div>
                )}
                ...
                {/* Card Header */}
                <div className="border-b border-white/10 bg-midnight/40 p-6 pt-12">
                ...
                {/* Card Body */}
                <div className="p-6">
                  <p className="mb-6 leading-relaxed text-moonlightSilver">
                    {pkg.description}
                  </p>

                  <div className="mb-6 rounded-lg bg-midnight/60 p-4 border border-white/5">
                  ...
                  <div className="mb-6">
                    <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-pearlWhite/70">
                      What's Included:
                    </p>
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          SECTION 4: HOW WE'LL WORK TOGETHER
      ═══════════════════════════════════════════════════════════════════ */}
      <section className="border-y border-green-500/20 bg-deepOcean/30 py-16 px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center">
              <div className="mb-4 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-green-500/20 border-2 border-green-400/40">
            ...
            <div className="text-center">
              <div className="mb-4 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-purple-500/20 border-2 border-purple-400/40">
                  <span className="text-3xl">🏰</span>
                </div>
              </div>
            ...
            <div className="text-center">
              <div className="mb-4 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-amber-500/20 border-2 border-pink-300/40">
                  <span className="text-3xl">✨</span>
                </div>
              </div>
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          SECTION 5: WHO THIS IS FOR (with floating lantern)
      ═══════════════════════════════════════════════════════════════════ */}
      <section className="py-16 px-6 bg-midnight/50 border-b border-green-500/20 relative">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-12">
            {/* Floating Lantern Icon */}
            <div className="flex justify-center mb-6">
              <GhibliLantern className="w-20 h-24" />
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border border-green-300/20 bg-green-300/5 p-6 backdrop-blur-sm hover:border-green-300/40 transition-all">
            ...
            <div className="rounded-lg border border-purple-200/20 bg-purple-200/5 p-6 backdrop-blur-sm hover:border-purple-200/40 transition-all">
              <div className="flex items-start gap-3">
            ...
            <div className="rounded-lg border border-pink-300/20 bg-pink-300/5 p-6 backdrop-blur-sm hover:border-pink-300/40 transition-all">
              <div className="flex items-start gap-3">
            ...
            <div className="rounded-lg border border-sky-300/20 bg-sky-300/5 p-6 backdrop-blur-sm hover:border-sky-300/40 transition-all">
              <div className="flex items-start gap-3">
                <span className="text-2xl flex-shrink-0">🚀</span>
                <div>
          ...
          <div className="mt-8 text-center">
            <p className="text-lg text-moonlightSilver">
              <span className="text-green-300 font-semibold">If you pour your heart into what you do</span>,
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          SECTION 6: FAQ (with consistent accordion)
      ═══════════════════════════════════════════════════════════════════ */}
      <section className="py-16 px-6 bg-deepOcean/30">
        <div className="mx-auto max-w-4xl">
          <h2 className="font-elegant mb-12 text-center text-3xl font-bold text-pearlWhite md:text-4xl">
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-4xl text-center">
          <div className="relative rounded-2xl border border-green-400/30 bg-gradient-to-br from-green-400/10 via-pink-300/10 to-purple-300/10 p-12 backdrop-blur-sm overflow-hidden">
            {/* Decorative clouds */}
            <GhibliCloud className="absolute top-0 left-0 w-full h-16 text-green-300 -translate-y-8 opacity-20" />
            <FloatingLeaf delay={0} className="absolute top-4 right-4" />
            <FloatingLeaf delay={2} className="absolute bottom-4 left-4" />

            <div className="relative z-10">
              <h2 className="font-elegant mb-4 text-3xl font-bold text-pearlWhite md:text-4xl">
                Ready to Begin?
              </h2>
              <p className="mb-8 text-lg text-moonlightSilver max-w-2xl mx-auto">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                ...
                <Link
                  href="/portfolio"
                  className="rounded-full border border-green-400/40 px-8 py-4 font-semibold text-green-300 transition-all hover:border-green-400/60 hover:bg-green-400/10"
                >
                  See My Work
                </Link>
              </div>
