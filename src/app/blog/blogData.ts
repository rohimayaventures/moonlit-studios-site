...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: 'ROOTED IN TWO WORLDS: The Courage to Begin Again',
    excerpt: 'A Most Influential Women feature on rebuilding, creating, and leading with empathy. My journey through nursing, reinvention, and building a creative-tech-cultural ecosystem grounded in healing and human connection.',
    category: 'Press & Features',
    tags: ['Press', 'Most Influential Women', 'Women in Leadership', 'Founders & Creators', 'Personal Journey'],
    date: '2025-01-18',
    readTime: '10 min',
    author: 'Hannah Kraulik Pagade',
